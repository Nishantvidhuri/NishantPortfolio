...
function FirstSectionHome() {
  ...
  return (
    <div className="w-full  relative text-white overflow-hidden">
      {/* PC/Laptop View: Full Background */}
      <div
      ...
      >
        ...
        <div className="relative z-10 mb-10 sm:mb-20 md:mb-[125px] ml-2 sm:ml-4 md:ml-[40px] translate-y-6 sm:translate-y-10 md:translate-y-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            ...
            >
              <div className="w-5 sm:w-6 md:w-7 h-4 sm:h-5">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  role="img"
      ...
      {/* Mobile View: Netflix-style Card */}
  ...
  {/* Navigation Buttons (Projects, Skills, Resume) */}
  <div className="absolute top-16 left-8 flex gap-4 text-xl">
    <button className="w-30 py-0.5 border-2 rounded-full border-gray-300 text-gray-300">Projects</button>
    <button className="w-30 py-0.5 border-2 rounded-full border-gray-300 text-gray-300">Skills</button>
    <button className="w-30 py-0.5 border-2 rounded-full border-gray-300 text-gray-300">Resume</button>
  </div>
  ...
  <div className="relative w-[90%] h-[90%] translate-y-14 flex flex-col items-center justify-center text-center">
    ...
    {/* Project Name */}
    <h2 className="text-5xl absolute top-[70%] font-[Teko] text-white">{projects[randomIndex].name}</h2>
